...
Target = theta;
InputX = P2;
OutputVec = zeros(2,10000);
HiddenUnits = 40;
InputAugment = ones(1,10000);
%InputAugment (:,:) = 1;
...
Alpha = 0.001;
% Weights
Weight1 = rand(HiddenUnits,3);
Weight2 = rand(2,HiddenUnits+1);
% error progression
errorprogression = zeros(2,iteration);
...
armLen = [0.4, 0.4];
origin = [0, 0];
[P11,P22] = RevoluteForwardKinematics2D(armLen, OutputVec, origin);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Old Testing code
